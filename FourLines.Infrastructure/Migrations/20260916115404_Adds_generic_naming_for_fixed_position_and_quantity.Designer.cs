...
namespace FourLines.Infrastructure.Migrations
{
    ...
    [Migration("20260916115404_Adds_generic_naming_for_fixed_position_and_quantity")]
    partial class Adds_generic_naming_for_fixed_position_and_quantity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FourLines.Domain.Models.Court", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "DefaultPrice", "FourLines.Domain.Models.Court.DefaultPrice#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("FourLines.Domain.Models.FacilitySchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasAlternateKey("FacilityId", "DayOfWeek")
                        .HasName("ak_facility_schedules_facility_id_day_of_week");
            ...
            modelBuilder.Entity("FourLines.Domain.Models.Reservation", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Period", "FourLines.Domain.Models.Reservation.Period#TimeRange", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Price", "FourLines.Domain.Models.Reservation.Price#Money", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_reservations_court_id");
