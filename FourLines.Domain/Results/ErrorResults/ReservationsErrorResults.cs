...
public static class ReservationsErrorResults
{
    ...
    public static readonly Error GetAllNoReservationsForUser = new("GetAllForUser.NoReservationsForUser", "No reservations found for the specified user id.");
    public static readonly Error GetAllNoReservationsForCourt = new("GetAllForCourt.NoReservationsForCourt", "No reservations found for the specified court id.");
